...
class Ai2Thor():
    def __init__(self):   
        ...
        self.maskrcnn_to_catname = {
            72:'Sink', 
            72:'SinkBasin', 61:'Toilet', 72:'Faucet', 59:'Bed', 74:'Book', 
            68:'CellPhone', 
            75:'AlarmClock', 'Laptop', 56:'Chair',
            62:'Television', 'RemoteControl', 58:'HousePlant', 
            56:'Ottoman', 56:'ArmChair', 57:'Sofa', 35:'BaseballBat', 39:'TennisRacket', 42:'Mug', 
    ...
    def init_network(self):
        ...
        self.optimizer = torch.optim.Adam(params=self.localpnet.parameters(),lr=0.0001)
    ...
    def get_detectron_conf_center_obj(self,im, frame=None):
        ...
        obj_pred_class = pred_classes[ind_obj]
    ...
    def detect_object_centroid(self, im, event):
        ...
        return xyz_obj_mid, obj_gt_class
    ...
    def run(self, mode, total_loss, summ_writer=None):
        ...
        while True: #successes < self.obj_per_scene and meta_obj_idx <= len(event.metadata['objects']) - 1: 
            ...
            actions = []
            confs = []
            confs.append(conf_cur.detach().cpu().numpy())
            episode_rewards = 0.0
            frame = 0
            while True:
                ...
                if mode=="train":
                    ...
                    for action_idx in [0,1,2,3]:
                        ...
                        rgb_t = event_t.frame
                        conf_t, _, obj_pred_class = self.get_detectron_conf_center_obj(rgb_t, frame)
                        if conf_t is None:

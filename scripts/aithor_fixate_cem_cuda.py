...
class Ai2Thor():
            ...
            if len(batch["rewards"]) == BATCH_SIZE:
                ...
                if summ_writer is not None:
                    ...
                    for ep_idx in range(len(all_obs)):
                        ...
                        rgb_camXs = torch.FloatTensor(rgb_cur).cuda().permute(0,3,1,2).unsqueeze(0)
    ...
    def run_episodes(self):
        ...
        for self.iteration, batch in enumerate(self.batch_iteration(self.mapnames_train,self.cemnet,self.BATCH_SIZE)):
            ...
            train_iters.append(self.iteration)
            ...
            if self.iteration % self.val_interval == 0:
                ...
                val_iters.append(self.iteration)
            ...
            if self.iteration % self.save_interval == 0:
                PATH = self.homepath + f'/checkpoint{self.iteration}.tar'
